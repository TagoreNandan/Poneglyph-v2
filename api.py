...
def generate_pdf(text: str, insights: Dict[str, Any]) -> io.BytesIO:
    ...
    content.append(Paragraph(f"Generated on: {timestamp} | Platform: Poneglyph Intelligence", meta_style))
    content.append(HRFlowable(width="100%", thickness=1.5, color=colors.HexColor("#E5E7EB"), spaceAfter=15))
    
    text = text.replace("Generated by ResearchPilot AI", "Archived by Poneglyph Intelligence")
    text = text.replace("Generated by Poneglyph", "Archived by Poneglyph Intelligence")
    lines = text.split("\n")
    in_references = False

...
const parseReportMarkdown = (markdown, fallbackTopic = '') => {
  ...
  let translatedMarkdown = markdown
    .replace(/Platform: ResearchPilot AI/g, "Platform: Poneglyph Research")
    .replace(/Platform: ResearchPilot/g, "Platform: Poneglyph Research")
    .replace(/Platform: Research Pilot/g, "Platform: Poneglyph Research")
    .replace(/Generated by ResearchPilot AI/g, "Compiled by Poneglyph Intelligence")
    .replace(/Generated by ResearchPilot/g, "Compiled by Poneglyph Intelligence")
    .replace(/Generated by Research Pilot/g, "Compiled by Poneglyph Intelligence")
    .replace(/Generated by Poneglyph(?!\s+Intelligence)/g, "Compiled by Poneglyph Intelligence")
    .replace(/Generated by Poneglyph Intelligence/g, "Compiled by Poneglyph Intelligence")
    .replace(/Archived by Poneglyph Intelligence/g, "Compiled by Poneglyph Intelligence")
    .replace(/ResearchPilot AI/g, "Poneglyph Intelligence")
    .replace(/ResearchPilot/g, "Poneglyph Intelligence")
    .replace(/Research Pilot/g, "Poneglyph Intelligence");

  // 1. Extract all image URLs
  const imgRegex = /!\[.*?\]\((.*?)\)/g;
  const images = [];
  let match;
  while ((match = imgRegex.exec(translatedMarkdown)) !== null) {
    images.push(match[1]);
  }

  // 2. Clean markdown text of image links
  let cleaned = translatedMarkdown.replace(/!\[.*?\]\((.*?)\)/g, '');
...
function App() {
  ...
  const handleDeleteReport = async (id) => {
    try {
      ...
      console.error("Failed to delete report on database:", err);
    }
  ...
  const handleGenerate = async (e, forcedQuery = null, bypass_ambiguity = null) => {
    ...
    try {
      ...
      if (!data.formatted_report || 
        ...
        setError("Research generation could not be completed at this time. Please try again shortly.");
        setIsLoading(false);
        return;
      }
                ...
                <div className="magazine-right">
                  ...
                  <div className="info-panel-card">
                    ...
                    <div className="info-panel-body">
                      ...
                      <div className="stat-line">
                        <span className="stat-label">Active Archives</span>
        ...
        <div className="main-content" onScroll={handleScroll}>
          {isLoading ? (
            <div className="loader">
              ...
              <p>{loadingMessages[loadingMessageIdx]}</p>
            </div>
          ) : activeReport ? (
            renderReportView()
          ) : activeNav === 'collections' ? (
